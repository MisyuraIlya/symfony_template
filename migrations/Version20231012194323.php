 ...
 */
final class Version20231012194323 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE history_detailed (id INT AUTO_INCREMENT NOT NULL, history_id INT DEFAULT NULL, product_id INT DEFAULT NULL, single_price INT DEFAULT NULL, quantity INT DEFAULT NULL, discount INT DEFAULT NULL, total INT DEFAULT NULL, INDEX IDX_C9A1DF641E058452 (history_id), UNIQUE INDEX UNIQ_C9A1DF644584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
