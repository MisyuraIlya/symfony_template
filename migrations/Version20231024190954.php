 ...
 */
final class Version20231024190954 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category ADD CONSTRAINT FK_64C19C1B6E62EFA FOREIGN KEY (attribute_id) REFERENCES attribute_main (id)');
