...
{
    private const TREASURE_NAMES = ['אחר- שרות השחזות','כלי שחיטה','מוצרים משלימים למטבח','השחזות','חומר גלם','טיפוח','קוצצים','מטבח וקולינריה','פינצטות','ברזלים סכינים ודוחפי עור','פצירות','טבחות'];
    ...
    protected function getDefaults(): array
    {
        return [
            ...
            'lvlNumber' => self::faker()->numberBetween(1, 3),
        ];
    }
