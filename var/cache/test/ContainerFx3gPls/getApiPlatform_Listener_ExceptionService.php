...
class getApiPlatform_Listener_ExceptionService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['api_platform.listener.exception'] = new \ApiPlatform\Symfony\EventListener\ExceptionListener(($container->privates['api_platform.error_listener'] ?? $container->load('getApiPlatform_ErrorListenerService')));
    }
}
