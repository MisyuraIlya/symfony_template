...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\FtpFileUploader' => 'getFtpFileUploaderService',
            'App\\Controller\\MyScheduleCalendarController' => 'getMyScheduleCalendarControllerService',
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).'/src/Serializer/MediaObjectNormalizer.php';
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9bCRof3oO8', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\AgentObjectiveRepository' => ['privates', 'App\\Repository\\AgentObjectiveRepository', 'getAgentObjectiveRepositoryService', true],
            'App\\Repository\\AgentTargetRepository' => ['privates', 'App\\Repository\\AgentTargetRepository', 'getAgentTargetRepositoryService', true],
            ...
            'App\\Repository\\ErrorRepository' => ['privates', 'App\\Repository\\ErrorRepository', 'getErrorRepositoryService', true],
            ...
            'App\\Repository\\MediaObjectRepository' => ['privates', 'App\\Repository\\MediaObjectRepository', 'getMediaObjectRepositoryService', true],
            ...
            'App\\Repository\\PackMainRepository' => ['privates', 'App\\Repository\\PackMainRepository', 'getPackMainRepositoryService', true],
            'App\\Repository\\PackProductsRepository' => ['privates', 'App\\Repository\\PackProductsRepository', 'getPackProductsRepositoryService', true],
            ...
            'App\\Repository\\PriceListUserRepository' => ['privates', 'App\\Repository\\PriceListUserRepository', 'getPriceListUserRepositoryService', true],
            'App\\Repository\\ProductAttributeRepository' => ['privates', 'App\\Repository\\ProductAttributeRepository', 'getProductAttributeRepositoryService', true],
            ...
            'App\\Repository\\SubAttributeRepository' => ['privates', 'App\\Repository\\SubAttributeRepository', 'getSubAttributeRepositoryService', true],
            ...
            'App\\Repository\\AgentObjectiveRepository' => '?',
            'App\\Repository\\AgentTargetRepository' => '?',
            ...
            'App\\Repository\\MediaObjectRepository' => '?',
            'App\\Repository\\MigvanRepository' => '?',
            'App\\Repository\\NotificationRepository' => '?',
            'App\\Repository\\PackMainRepository' => '?',
            'App\\Repository\\PackProductsRepository' => '?',
            'App\\Repository\\PriceListDetailedRepository' => '?',
            'App\\Repository\\PriceListRepository' => '?',
            'App\\Repository\\PriceListUserRepository' => '?',
            ...
            'App\\Repository\\SubAttributeRepository' => '?',
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('lexik_jwt_authentication.on_authentication_failure', [#[\Closure(name: 'App\\EventListener\\AuthenticationFailureListener')] fn () => ($container->privates['App\\EventListener\\AuthenticationFailureListener'] ??= new \App\EventListener\AuthenticationFailureListener()), 'onAuthenticationFailure'], 0);
        $instance->addListener('lexik_jwt_authentication.on_authentication_success', [#[\Closure(name: 'App\\EventListener\\LoginResponseListener')] fn () => ($container->privates['App\\EventListener\\LoginResponseListener'] ?? $container->load('getLoginResponseListenerService')), 'onAuthenticationSuccess'], 0);
    ...
    {
        return $container->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+Gx8CHMW+q', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9OMVuEATSO', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.resource_collection'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('VRDdVthgWO', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    protected static function getApiPlatform_FilterLocatorService($container)
    {
        return $container->privates['api_platform.filter_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'annotated_app_entity_agent_objective_api_platform_doctrine_orm_filter_date_filter' => ['privates', 'annotated_app_entity_agent_objective_api_platform_doctrine_orm_filter_date_filter', 'getAnnotatedAppEntityAgentObjectiveApiPlatformDoctrineOrmFilterDateFilterService', true],
            'annotated_app_entity_agent_objective_api_platform_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_agent_objective_api_platform_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityAgentObjectiveApiPlatformDoctrineOrmFilterSearchFilterService', true],
            'annotated_app_entity_agent_target_api_platform_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_agent_target_api_platform_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityAgentTargetApiPlatformDoctrineOrmFilterSearchFilterService', true],
            'annotated_app_entity_category_api_platform_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_category_api_platform_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityCategoryApiPlatformDoctrineOrmFilterSearchFilterService', true],
            'annotated_app_entity_history_api_platform_doctrine_orm_filter_date_filter' => ['privates', 'annotated_app_entity_history_api_platform_doctrine_orm_filter_date_filter', 'getAnnotatedAppEntityHistoryApiPlatformDoctrineOrmFilterDateFilterService', true],
            'annotated_app_entity_history_api_platform_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_history_api_platform_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityHistoryApiPlatformDoctrineOrmFilterSearchFilterService', true],
            'annotated_app_entity_history_detailed_api_platform_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_history_detailed_api_platform_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityHistoryDetailedApiPlatformDoctrineOrmFilterSearchFilterService', true],
            'annotated_app_entity_media_object_api_platform_doctrine_orm_filter_order_filter' => ['privates', 'annotated_app_entity_media_object_api_platform_doctrine_orm_filter_order_filter', 'getAnnotatedAppEntityMediaObjectApiPlatformDoctrineOrmFilterOrderFilterService', true],
            'annotated_app_entity_media_object_api_platform_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_media_object_api_platform_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityMediaObjectApiPlatformDoctrineOrmFilterSearchFilterService', true],
            'annotated_app_entity_product_api_platform_doctrine_orm_filter_boolean_filter' => ['privates', 'annotated_app_entity_product_api_platform_doctrine_orm_filter_boolean_filter', 'getAnnotatedAppEntityProductApiPlatformDoctrineOrmFilterBooleanFilterService', true],
            'annotated_app_entity_product_api_platform_doctrine_orm_filter_order_filter' => ['privates', 'annotated_app_entity_product_api_platform_doctrine_orm_filter_order_filter', 'getAnnotatedAppEntityProductApiPlatformDoctrineOrmFilterOrderFilterService', true],
            'annotated_app_entity_product_api_platform_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_product_api_platform_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityProductApiPlatformDoctrineOrmFilterSearchFilterService', true],
            ...
            'annotated_app_entity_agent_objective_api_platform_doctrine_orm_filter_date_filter' => '?',
            'annotated_app_entity_agent_objective_api_platform_doctrine_orm_filter_search_filter' => '?',
            'annotated_app_entity_agent_target_api_platform_doctrine_orm_filter_search_filter' => '?',
            'annotated_app_entity_category_api_platform_doctrine_orm_filter_search_filter' => '?',
            'annotated_app_entity_history_api_platform_doctrine_orm_filter_date_filter' => '?',
            'annotated_app_entity_history_api_platform_doctrine_orm_filter_search_filter' => '?',
            'annotated_app_entity_history_detailed_api_platform_doctrine_orm_filter_search_filter' => '?',
            'annotated_app_entity_media_object_api_platform_doctrine_orm_filter_order_filter' => '?',
            'annotated_app_entity_media_object_api_platform_doctrine_orm_filter_search_filter' => '?',
    ...
    {
        return $container->privates['api_platform.listener.view.validate_query_parameters'] = new \ApiPlatform\Symfony\EventListener\QueryParameterValidateListener(new \ApiPlatform\Api\QueryParameterValidator\QueryParameterValidator(($container->privates['api_platform.filter_locator'] ?? self::getApiPlatform_FilterLocatorService($container))), ($container->privates['api_platform.metadata.resource.metadata_collection_factory.cached'] ?? self::getApiPlatform_Metadata_Resource_MetadataCollectionFactory_CachedService($container)), true);
    }
    ...
    protected static function getApiPlatform_StateProvider_LocatorService($container)
    {
        return $container->privates['api_platform.state_provider.locator'] = new \ApiPlatform\State\CallableProvider(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\State\\AttributeStateProvider' => ['privates', 'App\\State\\AttributeStateProvider', 'getAttributeStateProviderService', true],
            'App\\State\\CartessetProvider' => ['privates', 'App\\State\\CartessetProvider', 'getCartessetProviderService', true],
            'App\\State\\CategoriesStateProvider' => ['privates', 'App\\State\\CategoriesStateProvider', 'getCategoriesStateProviderService', true],
            'App\\State\\DocumentsProvider' => ['privates', 'App\\State\\DocumentsProvider', 'getDocumentsProviderService', true],
            'App\\State\\ProductProvider' => ['privates', 'App\\State\\ProductProvider', 'getProductProviderService', true],
            'App\\State\\PurchaseHistoryProvider' => ['privates', 'App\\State\\PurchaseHistoryProvider', 'getPurchaseHistoryProviderService', true],
            'App\\State\\RestoreCartStateProvider' => ['privates', 'App\\State\\RestoreCartStateProvider', 'getRestoreCartStateProviderService', true],
            ...
            'App\\State\\AttributeStateProvider' => 'App\\State\\AttributeStateProvider',
            'App\\State\\CartessetProvider' => 'App\\State\\CartessetProvider',
            'App\\State\\CategoriesStateProvider' => 'App\\State\\CategoriesStateProvider',
            'App\\State\\DocumentsProvider' => 'App\\State\\DocumentsProvider',
            'App\\State\\ProductProvider' => 'App\\State\\ProductProvider',
            'App\\State\\PurchaseHistoryProvider' => 'App\\State\\PurchaseHistoryProvider',
            'App\\State\\RestoreCartStateProvider' => 'App\\State\\RestoreCartStateProvider',
    ...
    {
        return $container->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('o5pW6jLqlA', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    protected static function getDoctrine_Dbal_DefaultConnection_EventManagerService($container)
    {
        ...
        ]), [[['preUpdate'], 'vich_uploader.listener.clean.media_object'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_token_provider_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.pdo_session_handler_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.lock_store_schema_listener'], [['loadClassMetadata'], 'doctrine.orm.default_listeners.attach_entity_listeners'], [['preRemove'], 'vich_uploader.listener.remove.media_object'], [['postFlush'], 'vich_uploader.listener.remove.media_object'], [['prePersist'], 'vich_uploader.listener.upload.media_object'], [['preUpdate'], 'vich_uploader.listener.upload.media_object']]);
    }
    ...
    {
        $container->privates['doctrine.orm.default_xml_metadata_driver'] = $instance = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver([(\dirname(__DIR__, 4).'/vendor/gesdinet/jwt-refresh-token-bundle/Resources/config/doctrine') => 'Gesdinet\\JWTRefreshTokenBundle\\Entity', (\dirname(__DIR__, 4).'/vendor/vich/uploader-bundle/config/doctrine') => 'Vich\\UploaderBundle\\Entity'], '.orm.xml', true);
    ...
    protected static function getSerializerService($container)
    {
        ...
        $e = new \ApiPlatform\OpenApi\Serializer\ApiGatewayNormalizer(new \ApiPlatform\OpenApi\Serializer\OpenApiNormalizer(new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer(NULL, NULL, $b, $c)], [$d])));
        ...
        $o = new \Symfony\Component\Serializer\Mapping\ClassDiscriminatorFromClassMetadata($n);
        $p = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($n, $g, $b, $c, $o, NULL);

        return $container->privates['serializer'] = new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($b), new \App\Serializer\MediaObjectNormalizer(($container->privates['vich_uploader.storage.file_system'] ?? self::getVichUploader_Storage_FileSystemService($container))), new \ApiPlatform\RamseyUuid\Serializer\UuidDenormalizer(), $e, new \ApiPlatform\Hydra\Serializer\ConstraintViolationListNormalizer($f, [], $g), new \ApiPlatform\Problem\Serializer\ConstraintViolationListNormalizer([], $g), $e, new \ApiPlatform\Hydra\Serializer\DocumentationNormalizer($h, $i, $j, $k, $f, $g), new \ApiPlatform\Hydra\Serializer\EntrypointNormalizer($h, $l, $f), new \ApiPlatform\Hydra\Serializer\ErrorNormalizer($f, true), new \ApiPlatform\Problem\Serializer\ErrorNormalizer(true), new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true, translator: NULL), new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), new \ApiPlatform\JsonLd\Serializer\ItemNormalizer($h, $i, $j, $l, $k, $m, $b, $g, $n, [], $a), new \ApiPlatform\Serializer\ItemNormalizer($i, $j, $l, $k, $b, $g, $n, NULL, $h, $a), new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $g), new \Symfony\Component\Serializer\Normalizer\MimeMessageNormalizer(new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($n, $g, $c, $o, NULL)), new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($container->privates['mime_types'] ?? self::getMimeTypesService($container))), new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL), new \ApiPlatform\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionNormalizer($m, $k, $l, NULL), 'page', 'pagination', $h, $b), $h, $k, ($container->privates['api_platform.filter_locator'] ?? self::getApiPlatform_FilterLocatorService($container))), new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), new \ApiPlatform\JsonLd\Serializer\ObjectNormalizer($p, $l, $m), $p], [new \Symfony\Component\Serializer\Encoder\XmlEncoder(), $d, new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL), new \Symfony\Component\Serializer\Encoder\CsvEncoder(), new \ApiPlatform\Serializer\JsonEncoder('jsonld', NULL), new \ApiPlatform\Serializer\JsonEncoder('jsonproblem')]);
    }
    ...
    protected static function getValidator_BuilderService($container)
    {
        ...
        $instance->setConstraintValidatorFactory(new \Symfony\Component\Validator\ContainerConstraintValidatorFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Validator\\IsValidOrderValidator' => ['privates', 'App\\Validator\\IsValidOrderValidator', 'getIsValidOrderValidatorService', true],
            ...
            'App\\Validator\\IsValidOrderValidator' => '?',
     ...
     */
    protected static function getVichUploader_PropertyMappingFactoryService($container)
    {
     ...
     */
    protected static function getVichUploader_Storage_FileSystemService($container)
    {
        return $container->privates['vich_uploader.storage.file_system'] = new \Vich\UploaderBundle\Storage\FileSystemStorage(($container->privates['vich_uploader.property_mapping_factory'] ?? self::getVichUploader_PropertyMappingFactoryService($container)));
    }
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'app.erp' => $container->getEnv('ERP_TYPE'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'api_platform.resource_class_directories' => [
                ...
                2 => (\dirname(__DIR__, 4).'/src/ApiResource'),
                3 => (\dirname(__DIR__, 4).'/src/Entity'),
            ],
