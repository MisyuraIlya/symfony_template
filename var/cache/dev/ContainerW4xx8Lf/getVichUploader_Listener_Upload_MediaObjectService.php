...
class getVichUploader_Listener_Upload_MediaObjectService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.upload.media_object'])) {
            return $container->privates['vich_uploader.listener.upload.media_object'];
        }

        return $container->privates['vich_uploader.listener.upload.media_object'] = new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('media_object', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), $a);
    }
}
