...
class getGesdinet_Jwtrefreshtoken_RefreshTokenGeneratorService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->services['gesdinet.jwtrefreshtoken.refresh_token_generator'])) {
            return $container->services['gesdinet.jwtrefreshtoken.refresh_token_generator'];
        }

        return $container->services['gesdinet.jwtrefreshtoken.refresh_token_generator'] = new \Gesdinet\JWTRefreshTokenBundle\Generator\RefreshTokenGenerator($a);
    }
}
