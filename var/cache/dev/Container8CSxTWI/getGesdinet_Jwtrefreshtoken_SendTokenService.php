...
class getGesdinet_Jwtrefreshtoken_SendTokenService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['gesdinet.jwtrefreshtoken.send_token'])) {
            return $container->privates['gesdinet.jwtrefreshtoken.send_token'];
        }
        $b = ($container->services['gesdinet.jwtrefreshtoken.refresh_token_generator'] ?? $container->load('getGesdinet_Jwtrefreshtoken_RefreshTokenGeneratorService'));

        if (isset($container->privates['gesdinet.jwtrefreshtoken.send_token'])) {
            return $container->privates['gesdinet.jwtrefreshtoken.send_token'];
        }

        return $container->privates['gesdinet.jwtrefreshtoken.send_token'] = new \Gesdinet\JWTRefreshTokenBundle\EventListener\AttachRefreshTokenOnSuccessListener($a, 2592000, ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), 'refresh_token', false, $b, ($container->services['gesdinet.jwtrefreshtoken.request.extractor.chain'] ?? $container->load('getGesdinet_Jwtrefreshtoken_Request_Extractor_ChainService')), $container->parameters['gesdinet_jwt_refresh_token.cookie'], false, 'refresh_token_expiration');
    }
}
